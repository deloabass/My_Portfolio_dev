    ...
    <section id="contact" className="section">
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        <div className="mb-12 lg:mb-0 lg-flex lg:flex-col">
          <h2 className="headline-2 lg:max-ww-[12ch] reveal-up">Contact me for collaboration</h2>
        ...
        {/* API getFrom plateforme avec package lenis pour les animations avec gsap qui permet de vérifier les defilement  */}
        <form action="https://getform.io/f/alllxjna" method="POST" className="xl:pl-10 2xl:pl-20">
          ...
          <div className="mb-4">
            ...
            id="message"
             placeholder="HI!" 
             required 
             className="text-field resize-y min-h-32 mx-h-80 reveal-up"
             ></textArea>
          </div>
